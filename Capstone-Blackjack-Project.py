...
if another_card == 'n':
    ...
    if (21 - sum_of_your_hands) < (21 - sum_of_comp_hand):
        print("You win")
    else:
        print("You lose")
...
if another_card == 'y':
    ...
    print(f"Your cards: {your_cards}, final score: {sum_of_your_final_score}")
    print(f"Computer cards: {computer_cards}, final score: {sum_of_computer_final_score}")
